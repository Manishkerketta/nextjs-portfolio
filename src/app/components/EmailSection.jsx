...
const EmailSection = () => {
  ...
  const handleConfirm = (url, type) => {
    let message = "Are you sure you want to visit this profile?";
    
    if (type === "email") {
      message = "Do you want to connect through email?";
    }
      ...
      <footer className="bg-[#181818] text-white py-12 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col gap-4">
            {/* Email */}
            <button
              onClick={() => handleConfirm("https://mail.google.com/mail/u/0/#inbox?compose=new", "email")}
